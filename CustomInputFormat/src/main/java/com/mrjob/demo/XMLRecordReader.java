...
public class XMLRecordReader extends RecordReader<LongWritable, Text> 
{
    ...
    {
    System.out.println("input split location" +"="+ inputSplit.getLocations().toString());
    System.out.println("input split length" +"="+ inputSplit.getLength());
    ...
    {
	   System.out.println("key in getCurrentKey is " + "" +key);
    ...
    {
    System.out.println("value in getCurrentValue is " + "" +key);
